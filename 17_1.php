...
<?php
# Initialization
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_http.php");                        // http library
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_parse.php");                       // parse library
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_resolve_addresses.php");           // address resolution library
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_exclusion_list.php");              // list of excluded keywords
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_simple_spider.php");               // spider routines used by this app.
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_download_images.php");
