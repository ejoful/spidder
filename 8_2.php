...
<body>
<?php
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_pop3.php");
include("./WebbotsSpidersScreenScraper_Libraries_REV2_0/LIB_parse.php");
define("SERVER", "pop.qq.com");       // Name of your POP3 mail server
define("USER",   "2098903824@qq.com");     // Your POP3 email address
define("PASS",   "lxiyggdiobukbahb");          // Your POP3 password
